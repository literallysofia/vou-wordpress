...
if (class_exists('WP_Customize_Control')) {
    ...
    class Skyrocket_Image_Checkbox_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        {
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.css', array(), '1.0', 'all');
        }
        /**
...
?>
    ...
    class Skyrocket_Single_Accordion_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.js', array('jquery'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.css', array(), '1.0', 'all');
        }
        /**
         * Render the control in the customizer
    ...
    class Skyrocket_Slider_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.js', array('jquery', 'jquery-ui-core'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.css', array(), '1.0', 'all');
        }
        /**
         * Render the control in the customizer
    ...
    class Skyrocket_Dropdown_Select2_Custom_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            ...
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.js', array('skyrocket-select2-js'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.css', array(), '1.1', 'all');
    ...
    class Skyrocket_Customize_Alpha_Color_Control extends Skyrocket_Custom_Control
    {
        ...
        public function enqueue()
        {
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.js', array('jquery', 'wp-color-picker'), '1.0', true);
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_skyrocket_resource_url() . 'assets/customizer/customizer.css', array('wp-color-picker'), '1.0', 'all');
        }
        /**
         * Render the control in the customizer
         */
